            ...
            function ($templateCache) {
                $templateCache.put("vg-templates/next-video",
                    '<div class="loader-container" ng-if="ctrl.isCompleted">' +
                        '<round-progress max="ctrl.max" duration="50000" current="ctrl.current" color="#eeeeee" bgcolor="#333333" radius="50" stroke="10" animation="easeInOutQuart" animation-delay="0"></round-progress>' +
